...
contract UniswapV3MultiSwap {
    ...
    function swapExactInputMultihop(address tokenIn, address tokenMid, address tokenOut, uint256 amountIn) external returns (uint256 amountOut) {
        ...
        ISwapRouter.ExactInputParams memory params =
            ISwapRouter.ExactInputParams({
                path: abi.encodePacked(tokenIn, poolFee, tokenMid, poolFee, tokenOut),
